...
d = nrow(mydat[[1]])
d1 = d - 42 #choose back 28 days here
...
fname = paste('Policieseffectbenchmarkcountryconsider_',countryconsider,"_durationpolicy_",policytime,"_inflation_",inflation,"_iteration_",iteration,".txt",sep="")
