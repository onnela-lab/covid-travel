...
tname = paste('Coordinateeffectestimationcountryconsider_',countryconsider,"_durationpolicy_",policytime,"_inflation_",inflation,"_iteration_",iteration,".txt",sep="")
...
#####################
for (iteration in 1:nrep){
 tname1 = paste('Coordinateeffectbenchmarkcountryconsider_',countryconsider,"_durationpolicy_",policytime,"_inflation_",inflation,"_iteration_",iteration,".txt",sep="")
...
fname1 = paste("Zcoordinatebenchmarkcountryconsider_",countryconsider,".txt",sep="")
